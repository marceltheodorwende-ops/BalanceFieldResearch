...
- cross-stratum continuation audit: PASS
...
Current test suite: `149/149` pass.

Current source fingerprint: `5f9bb90432df834f9b9335ba4c1565ab33e9a74df81fc4a288847110b5f04f24`.
...
## Cross-stratum continuation gate

Hardening now checks the final finite support-transition layer.

A PASS requires:

- all smoke real states admit canonical support/self-continuation;
- retained witness mass is unity under identity continuation;
- controlled rank-increase and rank-decrease cases transport correctly;
- total witness annihilation reaches \(\bot\);
- a degenerate emergent lowest mode reaches the no-choice \(\bot\);
- a unique simple negative emergent mode constructs its canonical seed;
- ambient-unitary equivariance holds;
- finite switched transition products remain nonamplifying;
- no real crossing is falsely claimed when none is present.

No confirmatory held-out target is opened.
